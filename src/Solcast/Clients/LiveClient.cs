    ...
    public class LiveClient : BaseClient
    {
        ...
        )
        {
            ...
            catch (HttpRequestException httpEx)
            {
                ...
                throw new Exception($@"HTTP error in GetLiveAdvancedPvPower
...
Error: {httpEx.Message}", httpEx);
            ...
            {
                var paramDetails = "resourceId=" + resourceId + ", " + "hours=" + hours + ", " + "outputParameters=" + outputParameters + ", " + "period=" + period + ", " + "applyAvailability=" + applyAvailability + ", " + "applyConstraint=" + applyConstraint + ", " + "applyDustSoiling=" + applyDustSoiling + ", " + "applySnowSoiling=" + applySnowSoiling + ", " + "applyTrackerInactive=" + applyTrackerInactive + ", " + "terrainShading=" + terrainShading + ", " + "format=" + format;
                throw new Exception($@"Unhandled error in GetLiveAdvancedPvPower
Parameters: {paramDetails}
Error: {ex.Message}", ex);
            }
        }
...
Error: {ex.Message}", ex);
        ...
        )
        {
            ...
            catch (HttpRequestException httpEx)
            {
                ...
                var status = httpEx.StatusCode.HasValue ? ((int)httpEx.StatusCode).ToString() : "unknown";
                var content = httpEx.Data.Contains("Content") ? httpEx.Data["Content"] : "no content";
                throw new Exception($@"HTTP error in GetLiveRooftopPvPower
Parameters: {paramDetails}
Status Code: {status}
Content: {content}
Error: {httpEx.Message}", httpEx);
            ...
            {
                var paramDetails = "latitude=" + latitude + ", " + "longitude=" + longitude + ", " + "capacity=" + capacity + ", " + "hours=" + hours + ", " + "period=" + period + ", " + "tilt=" + tilt + ", " + "azimuth=" + azimuth + ", " + "installDate=" + installDate + ", " + "lossFactor=" + lossFactor + ", " + "outputParameters=" + outputParameters + ", " + "terrainShading=" + terrainShading + ", " + "format=" + format;
                throw new Exception($@"Unhandled error in GetLiveRooftopPvPower
Parameters: {paramDetails}
Error: {ex.Message}", ex);
            }
        }
        ...
        )
        {
            ...
            catch (HttpRequestException httpEx)
            {
                ...
                var status = httpEx.StatusCode.HasValue ? ((int)httpEx.StatusCode).ToString() : "unknown";
                var content = httpEx.Data.Contains("Content") ? httpEx.Data["Content"] : "no content";
                throw new Exception($@"HTTP error in GetLiveRadiationAndWeather
Parameters: {paramDetails}
Status Code: {status}
Content: {content}
Error: {httpEx.Message}", httpEx);
            ...
            {
                var paramDetails = "latitude=" + latitude + ", " + "longitude=" + longitude + ", " + "hours=" + hours + ", " + "period=" + period + ", " + "tilt=" + tilt + ", " + "azimuth=" + azimuth + ", " + "arrayType=" + arrayType + ", " + "outputParameters=" + outputParameters + ", " + "terrainShading=" + terrainShading + ", " + "format=" + format;
                throw new Exception($@"Unhandled error in GetLiveRadiationAndWeather
Parameters: {paramDetails}
Error: {ex.Message}", ex);
            }
        }
        ...
        /// <param name="format">Response format</param>
        public async Task<ApiResponse<EstimatedActualsDataResponse>> GetLiveKimber(
            double? latitude,
            double? longitude,
        ...
        )
        {
            try
            {
                ...
                var queryString = string.Join("&", parameters.Select(p => $"{p.Key}={Uri.EscapeDataString(p.Value ?? string.Empty)}"));
                var response = await _httpClient.GetAsync(SolcastUrls.LiveSoilingKimber + $"?{queryString}");
            ...
            {
                var paramDetails = "latitude=" + latitude + ", " + "longitude=" + longitude + ", " + "timeZone=" + timeZone + ", " + "hours=" + hours + ", " + "period=" + period + ", " + "cleaningThreshold=" + cleaningThreshold + ", " + "soilingLossRatePercent=" + soilingLossRatePercent + ", " + "gracePeriod=" + gracePeriod + ", " + "maxSoilingPercent=" + maxSoilingPercent + ", " + "initialSoilingPercent=" + initialSoilingPercent + ", " + "format=" + format;
                var status = httpEx.StatusCode.HasValue ? ((int)httpEx.StatusCode).ToString() : "unknown";
                var content = httpEx.Data.Contains("Content") ? httpEx.Data["Content"] : "no content";
                throw new Exception($@"HTTP error in GetLiveKimber
Parameters: {paramDetails}
Status Code: {status}
Content: {content}
Error: {httpEx.Message}", httpEx);
            ...
            {
                var paramDetails = "latitude=" + latitude + ", " + "longitude=" + longitude + ", " + "timeZone=" + timeZone + ", " + "hours=" + hours + ", " + "period=" + period + ", " + "cleaningThreshold=" + cleaningThreshold + ", " + "soilingLossRatePercent=" + soilingLossRatePercent + ", " + "gracePeriod=" + gracePeriod + ", " + "maxSoilingPercent=" + maxSoilingPercent + ", " + "initialSoilingPercent=" + initialSoilingPercent + ", " + "format=" + format;
                throw new Exception($@"Unhandled error in GetLiveKimber
Parameters: {paramDetails}
Error: {ex.Message}", ex);
            }
        }    }
