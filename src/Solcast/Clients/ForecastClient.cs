...
Error: {ex.Message}", ex);
        ...
        public async Task<ApiResponse<EstimateKimberLossFractionResponse>> GetForecastLosses(
        ...
        )
        {
            try
            {
                ...
                if (parameters.ContainsKey("format") && parameters["format"] == "json")
                {
                    var data = JsonConvert.DeserializeObject<EstimateKimberLossFractionResponse>(rawContent);
                    return new ApiResponse<EstimateKimberLossFractionResponse>(data, rawContent);
                }
                return new ApiResponse<EstimateKimberLossFractionResponse>(null, rawContent);
            }
            catch (UnauthorizedApiKeyException)
            {
                throw;
            ...
            {
                var paramDetails = "requestid=" + requestid + ", " + "latitude=" + latitude + ", " + "longitude=" + longitude + ", " + "hours=" + hours + ", " + "cleaningthreshold=" + cleaningthreshold + ", " + "soilinglossrate=" + soilinglossrate + ", " + "graceperiod=" + graceperiod + ", " + "maxsoiling=" + maxsoiling + ", " + "initialsoiling=" + initialsoiling + ", " + "rainaccumperiod=" + rainaccumperiod;
                var status = httpEx.StatusCode.HasValue ? ((int)httpEx.StatusCode).ToString() : "unknown";
                var content = httpEx.Data.Contains("Content") ? httpEx.Data["Content"] : "no content";
