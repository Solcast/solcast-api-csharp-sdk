...
namespace Solcast
{
    public static class SolcastUrls
    {
        ...
        public static readonly string LiveSoilingHsu = "data/live/soiling/hsu";
        ...
        public static readonly string ForecastPremiumWindPower = "data/forecast/premium_wind_power";
        public static readonly string ForecastSoilingHsu = "data/forecast/soiling/hsu";
        ...
        public static readonly string HistoricSoilingHsu = "data/historic/soiling/hsu";
