...
```csharp
var response = await client.Resources.Wind_power_site.PostAsync();
```
...
```csharp
var response = await client.Resources.Pv_power_site.PostAsync();
```
...
```csharp
var response = await client.Resources.Pv_power_site_measurements.PostAsync();
```
...
```csharp
var response = await client.Resources.Pv_power_site_measurements.Sub_units.PostAsync();
```
...
```csharp
var response = await client.Utility_scale_sites["{resource_id}"].Measurements.PostAsync();
```
...
```csharp
var response = await client.Resources.Wind_power_site_measurements.PostAsync();
```
...
```csharp
var response = await client.Resources.Wind_power_site_measurements.Sub_units.PostAsync();
```
...
```csharp
var response = await client.Resources.Wind_power_site.DeleteAsync(request =>
{
...
```csharp
var response = await client.Resources.Pv_power_site.DeleteAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
});
```
...
```csharp
var response = await client.Resources.Pv_power_site_measurements.DeleteAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
...
```csharp
var response = await client.Resources.Pv_power_site_measurements.Sub_units.DeleteAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
    request.QueryParameters.Start = start;
    request.QueryParameters.End = end;
...
```csharp
var response = await client.Resources.Wind_power_site_measurements.DeleteAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
    request.QueryParameters.Start = start;
    request.QueryParameters.End = end;
...
```csharp
var response = await client.Resources.Wind_power_site_measurements.Sub_units.DeleteAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
    request.QueryParameters.Start = start;
    request.QueryParameters.End = end;
...
```csharp
var response = await client.Resources.Wind_power_site.GetAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
});
```
...
```csharp
var response = await client.Resources.Pv_power_site.GetAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
});
```
...
```csharp
var response = await client.Resources.Pv_power_site_measurements.GetAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
});
```
...
```csharp
var response = await client.Resources.Pv_power_site_measurements.Sub_units.GetAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
});
```
...
```csharp
var response = await client.Resources.Wind_power_site_measurements.GetAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
});
```
...
```csharp
var response = await client.Resources.Wind_power_site_measurements.Sub_units.GetAsync(request =>
{
    request.QueryParameters.ResourceId = resourceId;
});
```
...
```csharp
var response = await client.Resources.Wind_power_sites.GetAsync();
```
...
```csharp
var response = await client.Resources.Pv_power_sites.GetAsync();
```
...
```csharp
var response = await client.Resources.Wind_power_site.PatchAsync();
```
...
```csharp
var response = await client.Resources.Pv_power_site.PatchAsync();
```
...
```csharp
var response = await client.Resources.Wind_power_site.PutAsync();
```
...
```csharp
var response = await client.Resources.Pv_power_site.PutAsync();
```
