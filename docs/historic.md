...
```csharp
var response = await client.Data.Historic.Advanced_pv_power.GetAsync(request =>
{
...
```csharp
var response = await client.Data.Historic.Radiation_and_weather.GetAsync(request =>
{
    request.QueryParameters.Start = start;
    request.QueryParameters.Latitude = latitude;
    request.QueryParameters.Longitude = longitude;
...
```csharp
var response = await client.Data.Historic.Rooftop_pv_power.GetAsync(request =>
{
    request.QueryParameters.Start = start;
    request.QueryParameters.Latitude = latitude;
    request.QueryParameters.Longitude = longitude;
